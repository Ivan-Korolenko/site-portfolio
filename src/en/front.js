    ...
    enquire
            ...
            match: function () {
                ...
                function wordRotate() {
                    ...
                    $('.section-1-word-rotate').wordsrotator({
                        words: ['websites', 'ideas', 'concepts', 'design', 'illustrations', 'algorithms', 'animations'],
                        randomize: false,
                        stopOnHover: true,
                        changeOnClick: false,
                        animationIn: "fadeIn",
                ...
                let section4AnimationTargets = document.querySelectorAll('#section-4-back #portfolio-cases a');
                ...
                function AnimationControlPlay(play, sectionNumber) {
                    if (play) {
                        if (sectionNumber.includes(1)) {
                            ...
                            //                //Частицы в первой секции
                            //                if (document.fifthParticlesLoadedBeforeFirst === true) {
                            //                    if (typeof pJSDom[1] !== 'undefined') {
                            //                        pJSDom[1].pJS.particles.move.enable = true;
                            //                        pJSDom[1].pJS.fn.particlesRefresh();
                            //                    }
                            //                }
                            //                //Частицы пятой секции еще не загружены, поэтому первыми в массиве стоят частицы первой секции
                            //                else {
                ...
                $('.section-2-why').click(function (event) {
                    ...
                    if ($('.section-2-why').hasClass('open')) {
                        $('.section-2-why').css('margin-bottom', '-38rem');
                    } else {
                        $('.section-2-why').css('margin-bottom', '-42rem');
                    }
                });
        ...
        .register("screen and (max-width:1280px) and (orientation:portrait)", {
            ...
            match: function () {
                ...
                let section4AnimationTargets = document.querySelectorAll('#section-4-back-mobile #portfolio-cases a');
                ...
                $('.section-2-why').click(function (event) {
                    $('.section-2-why').toggleClass('open');
                    if ($('.section-2-why').hasClass('open')) {
                        $('.section-2-why').css('margin-bottom', '-28rem');
                    } else {
                        $('.section-2-why').css('margin-bottom', '-30rem');
                    }
                });
                //Клик за пределами элемента, но не по самому элементу также вызывает закрытие
                $('.section-2').click(function (event) {
