            ...
            'ea_messenger': {
                text: `
                    ...
                    <ul>
                        ...
                        Приложение написано в функциональном стиле с архитектурой "командного центра", управляющего взаимодействиями между множеством dumb components, что значительно облегчает внесение изменений в рабочий поток приложения и добавление функционала, а также облегчает подключение в проект новых разработчиков (изменения в отдельных файлах не могут сломать всё приложение)
                        </li>
                        <li>На момент старта разработки Мессенджера был задействован еще на 2 крупных проектах. При этом до конца месяца проект должен был быть запущен в базовой версии. Пришлось за 2 дня написать большую часть функционала всего мессенджера и всё необходимое для первоначального запуска (архитектуру, переключение чатов, обмен сообщениями, загрузка истории, лоадеры, заглушки, обновление информации о пользователе и т.д.). Практически всё, что было написано в эти 2 дня, до сих пор работает в реальном приложении без ошибок. Все 3 проекта, в которых я участвовал, были запущены в срок (до конца месяца)</li>
                        <li>В процессе работы над проектом принимал участие в обсуждении архитектурных и детальных решений с командой бэкенд-разработчиков во главе с Алексеем Чалеем, а также организационных и бизнес-вопросов с заказчиками. Принимал участие в большинстве ключевых решений по проекту</li>
                    </ul><br><br>
                    <h3>Результаты</h3><br>
                    <ul>
                        <li>В краткие сроки (4 месяца с нуля до момента запуска с полным функционалом) самостоятельно создал фронтэнд приложения, являющегося улучшенным аналогом Телеграм Веб с дополнительным функционалом, таким как статистика, информация о клиенте, особые способы взаимодействия с чатами, (помимо обычного копирования сообщений в другие чаты и приглашения в чат других собеседников)</li>
                        <li></li>
                        <li>Операторы и бизнес довольны работой нового приложения</li>
                        <li>Обслуживать пользователей стало проще и удобнее. Производительность операторов увеличилась, а следовательно и доход компании.</li>
                    </ul><br><br>
                `,
                link: `
